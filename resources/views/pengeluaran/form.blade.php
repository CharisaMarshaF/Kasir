                             ...
                             <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <textarea class="form-control" placeholder="deskripsi" name="deskripsi" id="deskripsi" rows="3" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input class="form-control" placeholder="nominal" type="number" name="nominal" id="nominal"  required >
                                    </div>
                                </div>
