...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        <tr>
            <td>Total Harga:</td>
            <td class="text-right">{{ format_uang($sale->total_harga) }}</td>
        </tr>
        <tr>
            <td>Total Item:</td>
        ...
        <tr>
            <td>Diskon:</td>
            <td class="text-right">{{ format_uang($sale->diskon) }}</td>
        </tr>
        <tr>
            <td>Total Bayar:</td>
            <td class="text-right">{{ format_uang($sale->bayar) }}</td>
        </tr>
        <tr>
            <td>Diterima:</td>
            <td class="text-right">{{ format_uang($sale->diterima) }}</td>
        </tr>
        <tr>
            <td>Kembali:</td>
            <td class="text-right">{{ format_uang($sale->diterima - $sale->bayar) }}</td>
        </tr>
    </table>
