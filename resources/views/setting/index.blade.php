                                ...
                                <div class="box-header with-border p-2">
                                    <form action="{{ route('setting.update') }}" method="post" class="form-setting"
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" name="nama_perusahaan" class="form-control"
                                                        id="nama_perusahaan" required autofocus>
                                            ...
                                            <div class="form-group row">
                                                <label for="path_logo" class="col-lg-2 control-label">Logo
                                                    Perusahaan</label>
                                                <div class="col-lg-4">
                                            ...
                                            <div class="form-group row">
                                                <label for="path_kartu_member" class="col-lg-2 control-label">Kartu
                                                    Member</label>
                                                <div class="col-lg-4">
                                                    <input type="file" name="path_kartu_member" class="form-control"
                                                        id="path_kartu_member"
